...
add_action( 'comment_post', [ $this->integration_wp, 'proxy_post_comment_to_published' ], 10, 2 );
add_action( 'transition_comment_status', [ $this->integration_wp, 'proxy_transition_comment_status_to_published' ], 10, 3 );
...
add_filter( 'retrieve_password_message', [ $this->integration_wp_emails, 'disable_password_reset_notify_to_user' ], 100, 1 );
...
add_action( 'notification/trigger/action/did', [ $this->integration_bp, 'load_to_cron' ], 1, 2 );
