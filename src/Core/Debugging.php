...
class Debugging
{
	...
	public function catch_notification( $carrier, $trigger, $notification )
	{
		...
		if (apply_filters('notification/debug/suppress', (bool)notification_get_setting('debugging/settings/debug_suppressing'), $data['notification'], $data['carrier'], $data['trigger']) !== true) {
			return;
		}
