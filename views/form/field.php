...
<tr class="<?php echo esc_attr( $field->get_raw_name() ); ?>">
	...
	<td>
		<?php do_action_deprecated( 'notification/notification/box/field/pre', [ $this ], '[Next]', 'notification/carrier/box/field/pre' ); ?>
		...
		<?php endif ?>
		<?php do_action_deprecated( 'notification/notification/box/field/post', [ $this ], '[Next]', 'notification/carrier/box/field/post' ); ?>
