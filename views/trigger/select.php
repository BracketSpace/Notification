...
<select id="<?php $this->echo_var( 'select_name' ); ?>_select" name="<?php $this->echo_var( 'select_name' ); ?>" class="pretty-select" data-placeholder="<?php _e( 'Select trigger', 'notification' ); ?>">
