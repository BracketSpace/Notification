...
/**
 * Taxonomy permalink merge tag class
 */
class TaxonomyPermalink extends UrlTag {
    ...
    public function __construct( $params = array() ) {
    	...
    	$args = wp_parse_args( $params, array(
			'slug'        => $this->taxonomy . '_term_permalink',
			...
			'example'     => true,
			'resolver'    => function() {
				return get_term_link( $this->trigger->{ $this->taxonomy }->ID );
			},
		) );
