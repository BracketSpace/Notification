...
/**
 * Theme description merge tag class.
 */
class ThemeDescription  extends StringTag {
	...
	public function __construct( $params = array() ) {
		...
		$args = wp_parse_args(
			$params, array(
				'slug'        => $this->theme_version . '_theme_description',
				...
				'example'     => true,
				'resolver'    => function() {
					return $this->trigger->{'theme_' . $this->theme_version}->get( 'Description' );
				},
			)
		);
