...
/**
 * Theme URI merge tag class.
 */
class ThemeURI  extends StringTag {
	...
	public function __construct( $params = array() ) {
		...
		$args = wp_parse_args(
			$params, array(
				'slug'        => $this->theme_version . '_theme_uri',
				'name'        => __( 'Theme URI', 'notification' ),
				'description' => __( 'http://www.example.com', 'notification' ),
				'example'     => true,
				'resolver'    => function() {
					return $this->trigger->{'theme_' . $this->theme_version}->get( 'ThemeURI' );
				},
			)
		);
