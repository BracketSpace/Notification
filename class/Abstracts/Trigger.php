...
use BracketSpace\Notification\Core\Notification as NotificationCore;
...
abstract class Trigger extends Common implements Interfaces\Triggerable {
	 ...
	 *
	 * @param  NotificationCore $notification Notification class.
	 * @return void
	 */
	public function attach( NotificationCore $notification ) {
	 ...
	 * @return void
	 */
	public function detach( NotificationCore $notification ) {
