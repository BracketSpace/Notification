...
class Group {
	 ...
	 */
	public function __construct( $name, $slug, $section ) {
	...
	public function name( $name = null ) {
		...
		return apply_filters( 'notification/settings/group/name', $this->name, $this );
	...
	public function slug( $slug = null ) {
		...
		return apply_filters( 'notification/settings/group/slug', $this->slug, $this );
	...
	public function section( $section = null ) {
		...
		return apply_filters( 'notification/settings/group/section', $this->section, $this );
	...
	public function description( $description = null ) {
		...
		return apply_filters( 'notification/settings/group/description', $this->description, $this );
	...
	public function add_field( $args ) {
		...
		$field = new Field( $args['name'], $args['slug'], $this->section, $this->slug() );
	...
	public function get_fields() {
		...
		return apply_filters( 'notification/settings/group/fields', $this->fields );
