...
add_action( 'admin_menu', [ $this->admin_share, 'register_page' ], 30, 0 );
add_action( 'current_screen', [ $this->admin_share, 'maybe_redirect' ], 10, 0 );
add_action( 'admin_init', [ $this->admin_share, 'dismiss_story' ], 10, 0 );
