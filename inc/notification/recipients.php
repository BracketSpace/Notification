...
class Recipients extends Singleton {
	...
	public function register( $recipient ) {
		...
		if ( get_parent_class( $recipient ) != 'Notification\Notification\Recipient' ) {
			throw new \Exception( 'You can register only instance which extends class \\Notification\\Notification\\Recipient' );
